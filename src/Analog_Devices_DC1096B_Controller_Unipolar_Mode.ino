...
Date: 06-JUNE-2018
Purpose: Use an Arduino UNO (Atmega328) to control and drive the output of the Analog Devices DC1096B demo board set for unipolar output configuration (0V to +5V).

Usage:
         1. Connect DC1096B demo board to Arduino UNO per the connection diagram.
